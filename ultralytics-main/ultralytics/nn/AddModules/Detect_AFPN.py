...
__all__ = ['Detect_AFPN3', 'Detect_AFPN4']
...
class AFPN_P345_Custom(AFPN_P345):
    def __init__(self, in_channels=[256, 512, 1024], out_channels=256, block_type='C2f', factor=4):
        ...
        self.body = nn.Sequential(
            BlockBody_P345_Custom([in_channels[0] // factor, in_channels[1] // factor, in_channels[2] // factor],
                                  block_type)
        )
...
class AFPN_P2345(nn.Module):
    def __init__(self,
        ...
        self.body = nn.Sequential(
            BlockBody_P2345([in_channels[0] // factor, in_channels[1] // factor, in_channels[2] // factor,
...
class AFPN_P2345_Custom(AFPN_P2345):
    def __init__(self, in_channels=[256, 512, 1024], out_channels=256, block_type='C2f', factor=4):
        ...
        self.body = nn.Sequential(
            BlockBody_P2345_Custom([in_channels[0] // factor, in_channels[1] // factor, in_channels[2] // factor,
                                    in_channels[3] // factor], block_type)
        )


class Detect_AFPN3(nn.Module):
...
class Detect_AFPN4(Detect_AFPN3):
    """YOLOv8 Detect head with AFPN for detection models."""
    dynamic = False  # force grid reconstruction
    export = False  # export mode
    shape = None
